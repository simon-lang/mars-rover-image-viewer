...
/***/ function(module, exports, __webpack_require__) {
	...
	app.service('localStorageService', __webpack_require__(19));

	app.service('photoService', __webpack_require__(20));
	...
	_.each(directives, function(directive) {
	  return app.directive(directive, function() {
	    return {
	      template: __webpack_require__(21)("./" + directive + '.pug')
	    };
	  });
	});

	app.directive('loadImage', __webpack_require__(26));

	app.directive('selectOnClick', __webpack_require__(27));

	app.controller('MainController', __webpack_require__(28));

	app.run([
	  '$rootScope', '$window', function($rootScope, $window) {
	    var resize, scroll, top;
	    top = 0;
...
/***/ function(module, exports) {
	...
	module.exports = "<div class=\"header\"><div class=\"container\"><div class=\"row\"><div class=\"col-md-12\"><h1 class=\"brand-font\"><i class=\"fa fa-rocket pull-right\"></i> Mars Rover Image Viewer</h1></div></div></div></div>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	rovers = __webpack_require__(29);

	cameras = __webpack_require__(30);

	favourites = __webpack_require__(31);
