...
/***/ function(module, exports, __webpack_require__) {
	...
	app.service('localStorageService', __webpack_require__(9));

	app.service('photoService', __webpack_require__(10));
	...
	_.each(directives, function(directive) {
	  return app.directive(directive, function() {
	    return {
	      template: __webpack_require__(11)("./" + directive + '.pug')
	    };
	  });
	});

	app.controller('MainController', __webpack_require__(17));
...
/***/ function(module, exports) {
	...
	module.exports = "<ul class=\"nav nav-tabs\"><li class=\"link\" ng-class=\"{ active: pane === 'results'}\"><a ng-click=\"pane = 'results'\">Results</a></li><li class=\"link\" ng-class=\"{ active: pane === 'collected'}\"><a ng-click=\"pane = 'collected'\">Collected Images</a></li></ul>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	rovers = __webpack_require__(18);

	cameras = __webpack_require__(19);

	favourites = __webpack_require__(20);
